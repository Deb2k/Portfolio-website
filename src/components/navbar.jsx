  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl ">
      ...
      <div className="md:hidden lg:flex w-1/3 xl:justify-center">
       ...
       <span className="text-white mr-1">Debashis's</span>
       <span className="w-12 h-8 rounded bg-white text-black flex items-center justify-center">Portfolio </span>
       </Link>
      </div>
      {/* social */}
      <div className="hidden md:flex gap-4 w-1/3">
       ...
       <Image src="/github.png" alt="github image" width={24} height={24}/>
        ...
        <Link href="/">
       <Image src="/pinterest.png" alt="pinterest image" width={24} height={24}/>
       </Link>
        <Link href="/">
       <Image src="/instagram.png" alt="insta image" width={24} height={24}/>
       </Link>
        <Link href="/">
       <Image src="/facebook.png" alt="fb image" width={24} height={24}/>
       </Link>
        <Link href="/">
       <Image src="/linkedin.png" alt="linkein image" width={24} height={24}/>
       </Link>
      </div>
      {/* Responsive menu */}
      <div className="md:hidden">
        ...
        <motion.div 
          ...
          >
          {links.map((link)=>(<motion.div variants={listItemVariants} href={link.url} key={link.title}>{link.title}</motion.div>))}
        </motion.div>
        )
        }
